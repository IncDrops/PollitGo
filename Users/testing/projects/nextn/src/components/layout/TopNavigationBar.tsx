...
import { Settings2, UserCircle2, LogIn, UserPlus, Loader2, LogOut, Search } from 'lucide-react';
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
           <Link href="/search" passHref>
              <Button variant="ghost" size="icon" aria-label="Search">
                <Search className="h-5 w-5 sm:h-6 sm:w-6 text-nav-foreground" />
              </Button>
            </Link>
          {authLoading ? (
