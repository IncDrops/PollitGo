            ...
            {isOwnProfile ? (
              ...
              <>
                <Button 
                  ...
                  className={isFollowing ? "" : "bg-primary hover:bg-primary/90 text-primary-foreground"}
                >
                ...
                <Button variant="outline" disabled={!isAuthenticated && !authLoading} onClick={() => !isAuthenticated && signIn()}>
