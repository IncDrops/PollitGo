...
const twoOptionPolls: PollSkeleton[] = [
  ...
  { id: '2opt_charger_return_keep', creator: getRandomUser(), question: "Friend left charger. Return or fair game?", imageUrls: ['https://placehold.co/600x400.png'], options: [{ id: '2opt_charger_a', text: "Return, good karma" }, { id: '2opt_charger_b', text: "Finders keepers!" }], deadline: new Date(Date.now() + parseTimeRemaining("1 day")).toISOString(), createdAt: generateCreatedAt("1 day") },
  ...
  { id: '2opt_podcast_group_chat_dump', creator: getRandomUser(), question: "Turn unhinged group chat into podcast. Good idea or disaster?", imageUrls: ['https://placehold.co/600x400.png'], options: [{ id: '2opt_groupchat_a', text: "Genius! I'd listen." }, { id: '2opt_groupchat_b', text: "Friendships will end." }], deadline: new Date(Date.now() + parseTimeRemaining("3 days")).toISOString(), createdAt: generateCreatedAt("3 days") },
  { id: '2opt_kitkat_eating_method', creator: getRandomUser(), question: "Eat KitKat: Break fingers or bite whole thing like psycho?", imageUrls: ['https://placehold.co/600x400.png'], options: [{ id: '2opt_kitkat_a', text: "Break fingers, civilized" }, { id: '2opt_kitkat_b', text: "Whole thing, chaos mode" }], deadline: new Date(Date.now() + parseTimeRemaining("10 minutes")).toISOString(), createdAt: generateCreatedAt("10 minutes") },
  ...
  { id: '2opt_work_from_home_office', creator: getRandomUser(), question: "Ideal work setup: Work from home or in the office?", imageUrls: ['https://placehold.co/600x400.png'], options: [{ id: '2opt_wfh_a', text: "Home sweet office" }, { id: '2opt_wfh_b', text: "Office for collaboration" }], deadline: new Date(Date.now() + parseTimeRemaining("10 days")).toISOString(), createdAt: generateCreatedAt("10 days") },
...
const threeOptionPolls: PollSkeleton[] = [
  ...
  { id: '3opt_pet_preference', creator: getRandomUser(), question: 'Preferred pet: Dog, Cat, or Something else?', imageUrls: ['https://placehold.co/600x400.png'], options: [{ id: '3opt_pet_a', text: 'Dog (Man\'s best friend)' }, { id: '3opt_pet_b', text: 'Cat (Feline overlord)' }, { id: '3opt_pet_c', text: 'Something else (Fish, bird, etc.)' }], deadline: new Date(Date.now() + parseTimeRemaining("7 days")).toISOString(), createdAt: generateCreatedAt("7 days") },
  ...
  { id: '3opt_you_up_reply_chaos', creator: getRandomUser(), question: "Got 'you up?' text at 2 AM. Max chaos/comedy reply?", imageUrls: ['https://placehold.co/600x400.png'], options: [{ id: 'yur1_opt_a', text: "'New phone, who dis?'" }, { id: 'yur1_opt_b', text: "'Yes, and I was just thinking of you... not.'" }, { id: 'yur1_opt_c', text: "Send Wikipedia link to 'Sleep'" }], deadline: new Date(Date.now() + parseTimeRemaining("5 minutes")).toISOString(), createdAt: generateCreatedAt("5 minutes") },
